...
public class Header extends PdfPageEventForwarder {
  ...
  public void onEndPage(final PdfWriter writer, final Document document) {
    try {
      ...
      Phrase projectName = new Phrase(project.getName(), FontFactory.getFont(FontFactory.COURIER, 12, Font.NORMAL, BaseColor.GRAY));
      Phrase phrase = new Phrase("Sonar PDF Report", FontFactory.getFont(FontFactory.COURIER, 12, Font.NORMAL, BaseColor.GRAY));
