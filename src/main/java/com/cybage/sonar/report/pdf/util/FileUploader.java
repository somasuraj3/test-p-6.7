...
public class FileUploader {
	...
	public static void upload(final File report, final String url, String username, String password) {
		...
		PostMethod filePost = new PostMethod(url + "/api/ce/submit?projectKey=ALMMaturity_JenkinsService_API_Feature:feature&projectName=ALMMaturity_JenkinsService_API_Feature");
