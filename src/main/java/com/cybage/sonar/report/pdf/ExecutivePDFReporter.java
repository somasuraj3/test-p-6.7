...
/*		// Dynamic Analysis 
		...
		getTendencyImage(project.getMeasure(MetricKeys.TECHNICAL_DEBT).getQualitativeTendency(),
		...
		getTendencyImage(project.getMeasure(MetricKeys.VIOLATIONS).getQualitativeTendency(),
